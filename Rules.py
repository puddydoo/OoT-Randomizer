...
def set_rules(world):
    ...
    for location in world.get_locations():
        ...
        if location.name == 'Forest Temple MQ First Room Chest' and world.shuffle_bosskeys == 'dungeon' and world.shuffle_smallkeys == 'dungeon' and world.dungeon_tokens == 'vanilla':
