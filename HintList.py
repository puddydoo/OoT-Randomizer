...
hintTable = {
    ...
    'Giants Knife (Limited)':                                   (["a fragile blade", "a breakable cleaver"], "the Giant's Knife", 'item'),
    ...
    'Deku Shield (Limited)':                                    (["a wooden ward", "a burnable barrier"], "a Deku Shield", 'item'),
    'Hylian Shield':                                            (["a steel safeguard", "Like Like's metal meal"], "a Hylian Shield", 'item'),
    'Hylian Shield (Limited)':                                  (["a steel safeguard", "Like Like's metal meal"], "a Hylian Shield", 'item'),
    ...
    'Deku Stick (1) (Limited)':                                 ("a breakable branch", 'a Deku Stick', 'item'),
    ...
    'Bombchus (5) (Limited)':                                   (["a few mice bombs", "a few proximity mice", "a few wall crawlers", "a few trail blazers"], "Bombchus (5 pieces)", 'item'),
    'Bombchus (10)':                                            (["some mice bombs", "some proximity mice", "some wall crawlers", "some trail blazers"], "Bombchus (10 pieces)", 'item'),
    'Bombchus (10) (Limited)':                                  (["some mice bombs", "some proximity mice", "some wall crawlers", "some trail blazers"], "Bombchus (10 pieces)", 'item'),
    ...
    'Bombchus (20) (Limited)':                                  (["plenty of mice bombs", "plenty of proximity mice", "plenty of wall crawlers", "plenty of trail blazers"], "Bombchus (20 pieces)", 'item'),
    'Deku Nuts (5)':                                            (["some nuts", "some flashbangs", "some scrub spit"], "Deku Nuts (5 pieces)", 'item'),
    'Deku Nuts (5) (Limited)':                                  (["some nuts", "some flashbangs", "some scrub spit"], "Deku Nuts (5 pieces)", 'item'),
    'Deku Nuts (10)':                                           (["lots-o-nuts", "plenty of flashbangs", "plenty of scrub spit"], "Deku Nuts (10 pieces)", 'item'),
    'Deku Nuts (10) (Limited)':                                 (["lots-o-nuts", "plenty of flashbangs", "plenty of scrub spit"], "Deku Nuts (10 pieces)", 'item'),
