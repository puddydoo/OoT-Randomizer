...
location_table = OrderedDict([
    ...
    ("Market Fish Sale",                                ("Event",       None,  None, None,                     ("the Market", "Market",))),
    ("Market Blue Fire Sale",                           ("Event",       None,  None, None,                     ("the Market", "Market",))),
    ("Kak Bug Sale",                                    ("Event",       None,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Fish Sale",                                   ("Event",       None,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Blue Fire Sale",                              ("Event",       None,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Keaton Mask Sale",                            ("Event",       None,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("LW Skull Mask Sale",                              ("Event",       None,  None, None,                     ("the Lost Woods", "Forest",))),
    ("Graveyard Spooky Mask Sale",                      ("Event",       None,  None, None,                     ("the Graveyard", "Kakariko",))),
    ("HF Bunny Hood Sale",                              ("Event",       None,  None, None,                     ("Hyrule Field",))),
