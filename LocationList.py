...
location_table = OrderedDict([
    ...
    ("LW Odd Mushroom",                                 ("NPC",         0x5B,  0x1F, None,                     ("the Lost Woods", "Forest",))),
    ("LW Poachers Saw",                                 ("NPC",         0x5B,  0x21, None,                     ("the Lost Woods", "Forest",))),
    ...
    ("Kak Cojiro",                                      ("NPC",         0x52,  0x0E, None,                     ("Kakariko Village", "Kakariko",))),
    ...
    ("Kak Odd Potion",                                  ("NPC",         0x4E,  0x20, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Granny Blue Potion",                          ("NPC",         0x4E,  0x12, None,                     ("Kakariko Village", "Kakariko",))),
    ...
    ("DMT Prescription",                                ("NPC",         0x60,  0x23, None,                     ("Death Mountain Trail", "Death Mountain",))),
    ("DMT Claim Check",                                 ("NPC",         0x60,  0x26, None,                     ("Death Mountain Trail", "Death Mountain",))),
    ...
    ("ZD Eyeball Frog",                                 ("NPC",         0x58,  0x24, None,                     ("Zora's Domain",))),
    ...
    ("LH Eyedrops",                                     ("NPC",         0x38,  0x25, None,                     ("Lake Hylia",))),
    ...
    ("GV Broken Sword",                                 ("NPC",         0x5A,  0x22, None,                     ("Gerudo Valley", "Gerudo",))),
    ...
    ("Market Mask Shop Keaton Mask",                    ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Skull Mask",                     ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Spooky Mask",                    ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Bunny Hood",                     ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Zora Mask",                      ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Goron Mask",                     ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Gerudo Mask",                    ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ("Market Mask Shop Mask of Truth",                  ("Event",       0x33,  None, None,                     ("the Market", "Market",))),
    ...
    ("Market Poe Sale",                                 ("Event",       0x4D,  None, None,                     ("the Market", "Hyrule Castle",))),
    ("Market Big Poe Sale",                             ("Event",       0x4D,  None, None,                     ("the Market", "Hyrule Castle",))),
    ("Market Bug Sale",                                 ("Event",       0x20,  None, None,                     ("the Market", "Market",))),
    ("Market Fish Sale",                                ("Event",       0x20,  None, None,                     ("the Market", "Market",))),
    ("Market Blue Fire Sale",                           ("Event",       0x20,  None, None,                     ("the Market", "Market",))),
    ("Kak Bug Sale",                                    ("Event",       0x52,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Fish Sale",                                   ("Event",       0x52,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Blue Fire Sale",                              ("Event",       0x52,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("Kak Keaton Mask Sale",                            ("Event",       0x52,  None, None,                     ("Kakariko Village", "Kakariko",))),
    ("LW Skull Mask Sale",                              ("Event",       0x5B,  None, None,                     ("the Lost Woods", "Forest",))),
    ("Graveyard Spooky Mask Sale",                      ("Event",       0x53,  None, None,                     ("the Graveyard", "Kakariko",))),
    ("HF Bunny Hood Sale",                              ("Event",       0x51,  None, None,                     ("Hyrule Field",))),
