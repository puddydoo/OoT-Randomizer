...
item_table = {
    ...
    'Gold Skulltula Token (Hyrule Field)':             ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Market)':                   ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Lon Lon Ranch)':            ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Kakariko)':                 ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Death Mountain)':           ('Token',    True,  0x5B, {'token': True}),
    ...
    'Gold Skulltula Token (Desert)':                   ('Token',    True,  0x5B, {'token': True}),
