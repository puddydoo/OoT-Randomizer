...
item_table = {
    ...
    'Spooky Mask':                                     ('Item',     True,  0x18, None),
    'Keaton Mask':                                     ('Item',     True,  0x1A, None),
    'Bunny Hood':                                      ('Item',     True,  0x1B, None),
    ...
    'Buy Poe':                          ('Shop',     True,  0x2A, {'object': 0x0176, 'price': 30}),
