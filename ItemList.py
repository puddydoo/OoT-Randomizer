...
item_table = {
    ...
    'Gold Skulltula Token':                            ('Token',    True,  0x5B, {'token': True}),
    ...
    'Gold Skulltula Token (Kokiri Forest)':            ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Lost Woods)':               ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Sacred Forest Meadow)':     ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Market Guard House)':       ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Hyrule Castle Grounds)':    ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Grotto)':                   ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Ganons Castle Grounds)':    ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Lon Lon Ranch)':            ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Kakariko Village)':         ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Graveyard)':                ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Death Mountain Trail)':     ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Goron City)':               ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Death Mountain Crater)':    ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Zoras River)':              ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Zoras Domain)':             ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Zoras Fountain)':           ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Lake Hylia)':               ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (LH Lab)':                   ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Gerudo Valley)':            ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Gerudo Fortress)':          ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Haunted Wasteland)':        ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Desert Colossus)':          ('Token',    True,  0x5B, {'token': True}),
    'Gold Skulltula Token (Deku Tree)':                ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Dodongos Cavern)':          ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Jabu Jabus Belly)':         ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Forest Temple)':            ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Fire Temple)':              ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Water Temple)':             ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Spirit Temple)':            ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Shadow Temple)':            ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Bottom of the Well)':       ('DungeonToken',True,0x5B,{'token': True}),
    'Gold Skulltula Token (Ice Cavern)':               ('DungeonToken',True,0x5B,{'token': True}),
