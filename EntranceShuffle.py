...
entrance_shuffle_table = [
    ...
    ('Dungeon',         ('DMC Fire Temple Entrance -> Fire Temple Lower',                   { 'index': 0x0165 }),
                        ('Fire Temple Lower -> DMC From Fire Temple',                       { 'index': 0x024A, 'blue_warp': 0x0564 })),
    ...
    ('Interior',        ('DMC Great Fairy Fountain Entrance -> DMC Great Fairy Fountain',   { 'index': 0x04BE }),
                        ('DMC Great Fairy Fountain -> DMC From Great Fairy Fountain',       { 'index': 0x0482, 'addresses': [0xBEFD6A] })),
    ...
    ('Grotto',          ('DMC Hammer Grotto Entrance -> DMC Hammer Grotto',                 { 'grotto_id': 0x05, 'entrance': 0x05A4, 'content': 0xF9, 'scene': 0x61 }),
                        ('DMC Hammer Grotto -> DMC From Hammer Grotto',                     { 'grotto_id': 0x05 })),
    ('Grotto',          ('DMC Upper Grotto Entrance -> DMC Upper Grotto',                   { 'grotto_id': 0x06, 'entrance': 0x003F, 'content': 0x7A, 'scene': 0x61 }),
                        ('DMC Upper Grotto -> DMC From Upper Grotto',                       { 'grotto_id': 0x06 })),
    ...
    ('Overworld',       ('GC Darunias Chamber -> DMC From Goron City',                      { 'index': 0x0246 }),
                        ('DMC Goron City Entrance -> GC Darunias Chamber',                  { 'index': 0x01C1 })),
    ('Overworld',       ('Death Mountain Summit -> DMC From Summit',                        { 'index': 0x0147 }),
                        ('DMC Summit Entrance -> Death Mountain Summit',                    { 'index': 0x01BD })),
    ...
    ('WarpSong',        ('Bolero of Fire Warp -> DMC From Warp Pad',                        { 'index': 0x04F6, 'addresses': [0xBF023E] })),
