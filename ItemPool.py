...
fixedlocations = {
    ...
    'Market Bombchu Bowling Bombchus': 'Bombchus (10)',
}

droplocations = {
    'Deku Baba Sticks': 'Deku Stick (1)',
    'Deku Baba Nuts': 'Deku Nuts (5)',
    'Stick Pot': 'Deku Stick (1)',
    'Nut Pot': 'Deku Nuts (5)',
    'Nut Crate': 'Deku Nuts (5)',
    'Blue Fire': 'Blue Fire',
    'Lone Fish': 'Fish',
    'Fish Group': 'Fish',
    'Bug Rock': 'Bugs',
...
exclude_from_major = [ 
    ...
    'Magic Bean',
    'Zeldas Letter',
    'Bombchus (5) (Non-Repeatable)',
    'Bombchus (10) (Non-Repeatable)',
    'Bombchus (20) (Non-Repeatable)',
    'Odd Potion',
    'Triforce Piece'
]
